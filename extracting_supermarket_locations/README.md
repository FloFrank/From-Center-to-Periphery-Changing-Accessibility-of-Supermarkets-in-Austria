...
The extraction was carried out using PostGIS based on the company name, website address, and ÖNACE classification from the location dataset of all retail enterprises in Austria.
